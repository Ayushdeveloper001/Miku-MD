...
//Some special chat replies
 ...
 let smallinput = budy.toLowerCase()
    ...
    if (smallinput=='bot') {
      reply (`Hello *${pushname}*, I am *${BotName}*, a WhatsApp bot made by *Ayush* and currently being hosted by *${OwnerName}*.  type  *${prefix}help* to get my full command list.`);
    }
...
case 'repo': case 'botrepo':
    ...
    reply(`*My Source Code is private`)
    break
...
case 'charactercheck':
    ...
    if (isBanChat) return reply(mess.bangc)
					...
					const Mikutttt =['Compassionate','Generous','Grumpy','Forgiving','ObedFantoxient','Good','Simp','Kind-Hearted','patient','UwU','top, anyway','Helpful']
...
I am *Miku Nakano*, a bot developed by *Ayush*.
